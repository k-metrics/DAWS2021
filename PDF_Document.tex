...
\hypersetup{
  pdftitle={PDF Document Template},
...
\item
  ...
  \item
    ...
    \tightlist
    \item
      \texttt{tinytex::tlmgr\_install("package")}
    \end{itemize}
  \item
...
\begin{center}\includegraphics{PDF_Document_files/figure-latex/pressure-1} \end{center}
...
{\centering \includegraphics{PDF_Document_files/figure-latex/unnamed-chunk-1-1} 
